...
exports.lista = async (req, res) => {
    ...
    res.render('recursos/empleados/listView', {
        list: traer,
    })
}
...
exports.formRegistro = async (req, res) => {
    ...
    res.render('recursos/empleados/registroView')
}
...
exports.datos = async (req, res) => {
    ...
    res.render('recursos/empleados/datosView', {
        usuario: traer,
    })
}
...
exports.actualizarForm = async (req, res) => {
    ...
    const traer = await byId(id)
    res.render('recursos/empleados/actualizarView', {
        usuario: traer,
    })
}
